...
# as views são  as funções que eu crio para meu projeto que vão manipular os dados no banco de dados e trazer para o nosso usuário
# toda função começa com a palavra def
